...
We generate five patient data sets with the same change point.
...
```{r print_model3b, eval=FALSE}
load(file="Fit/fit3b.Rdata")
print(fit3b, pars = c("a", "e", "l", "s", "sigma"), probs= c(0.025, 0.5, 0.975))
```
The estimates of the third model M3 with five patients estimates will, but did not achieve complete convergence at 1000 iterations.
...
crashes for unexplained reason. error message saved as *error Model 5.txt*
